...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        llmManager.onInferenceCompleted.AddListener(llmResponse =>
        {
            ...
            var isAiStoryGeneration = llmResponse.GetStory() != null;
            ...
            ttsManager.Speak(aiNextVoice, () =>
            {
                ...
                {
                    // AI just told a story, now AI should pick an object for user to tell story about
                ...
                {
                    // AI just evaluated user's story, now prompt user to pick object for AI
